							...
							<form method = "POST" enctype = "multipart/form-data" action = "add_comp.php">
								...
								<div style = "width:40%; margin-left:32%;">	
									<div class = "form-group">
										...
										<input type = "text" class = "form-control" value ="<?php echo $u_issue['issue_id']?>" name = "issue_id" READONLY required = "required"/>
									</div>
									<div class = "form-group">
									...
									<div class = "form-group">
										...
										<input type = "text" class = "form-control"  name = "issue_date" required= "required" READONLY/>
									</div>
									<div class = "form-group">
