...
$pdf->Cell(8	,5,'RS',1,0);
$pdf->Cell(26	,5,number_format($amount*$invoice['tax']/100),1,1,'R');//end of line

$pdf->Cell(130	,5,'',0,0);
$pdf->Cell(25	,5,'Tax Rate',0,0);
$pdf->Cell(8	,5,'RS',1,0);
$pdf->Cell(26	,5,number_format($invoice['tax'])."%",1,1,'R');//end of line

$pdf->Cell(130	,5,'',0,0);
$pdf->Cell(25	,5,'Grand Total',0,0);
$pdf->Cell(8	,5,'RS',1,0);
$pdf->Cell(26	,5,number_format($invoice['grand_total']),1,1,'R');//end of line
